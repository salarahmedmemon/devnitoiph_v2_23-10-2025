...
const SectionThree = () => {
    ...
    return (
        <div className="w-full bg-[#0A131C]">
            <div className="servicedetailspage-sectionthree mx-auto w-full h-[2380px] sm:h-[2580px] md:h-[1600px] lg:h-[1900px]  xl:h-[2400px] relative">
                <div className="image w-full h-[40vh] absolute top-[10vw] lg:top-[104px] p-4 left-0 text-white  lg:left-[5%]   xl:top-[140px] xl:left-[0px]">
                ...
                <div className="md:hidden lg:block ListOfServices w-[90%] sm:w-[94%] border-1 border-[#423D4C] absolute top-[1360px] right-[5vw] sm:right-[3vw] sm:top-[1600px] p-4 rounded-lg lg:w-[24%] lg:top-[116px] lg:border-[2px] lg:right-[7%]   xl:w-[413px] xl:h-[513px] xl:right-[20px] xl:top-[152px] xl:p-2 xl:border-[1px]">
                ...
                <div className="md:hidden lg:block ListOfServices text-white w-[90%] sm:w-[94%] border-1 border-[#423D4C] absolute top-[1900px] sm:top-[2140px] right-[5vw] sm:right-[3vw] p-4 rounded-lg     lg:w-[24%] lg:border-[2px] lg:right-[7%]  lg:top-[650px]   xl:w-[413px] xl:h-[269px] xl:right-[20px] xl:top-[720px] xl:p-2 xl:border-[1px]">
                ...
                <div className="md:hidden lg:block ListOfServices text-white w-[90%] sm:w-[94%] border-1 border-[#423D4C] absolute top-[2220px] sm:top-[2420px] right-[5vw] sm:right-[3vw] p-4 rounded-lg  lg:w-[24%] lg:top-[1000px] lg:border-[2px] lg:right-[7%]  xl:w-[413px] xl:h-[160px] xl:right-[20px] xl:top-[1050px] xl:p-2 xl:border-[1px]">
