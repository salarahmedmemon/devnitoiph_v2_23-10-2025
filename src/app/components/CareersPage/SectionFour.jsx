                    ...
                    <div className="w-full md:w-[600px] xl:w-[640px] h-[492px]">
                        ...
                        <div className="w-full mt-[20px]">
                            <ul className="flex flex-wrap items-center justify-center lg:justify-start  gap-4">
                                <li className="w-full sm:w-[200px] xl:w-[282px] sm:h-[49px] text-[16px] xl:text-[20px] font-[600] text-[#4C4886] bg-white rounded-[7px] p-[10px] border-l-[2px] border-[#4C4886] hover:bg-[#4C4886] hover:text-white transition-all duration-200 ease-in-out cursor-pointer">Remote IT Assistance</li>
                                <li className="w-full sm:w-[200px] xl:w-[282px] sm:h-[49px] text-[16px] xl:text-[20px] font-[600] text-[#4C4886] bg-white rounded-[7px] p-[10px] border-l-[2px] border-[#4C4886] hover:bg-[#4C4886] hover:text-white transition-all duration-200 ease-in-out cursor-pointer">Cloud Services</li>
                                <li className="w-full sm:w-[200px] xl:w-[282px] sm:h-[49px] text-[16px] xl:text-[20px] font-[600] text-[#4C4886] bg-white rounded-[7px] p-[10px] border-l-[2px] border-[#4C4886] hover:bg-[#4C4886] hover:text-white transition-all duration-200 ease-in-out cursor-pointer">Managed IT Service</li>
                                <li className="w-full sm:w-[200px] xl:w-[282px] sm:h-[49px] text-[16px] xl:text-[20px] font-[600] text-[#4C4886] bg-white rounded-[7px] p-[10px] border-l-[2px] border-[#4C4886] hover:bg-[#4C4886] hover:text-white transition-all duration-200 ease-in-out cursor-pointer">Remote IT Assistance</li>
                                <li className="w-full sm:w-[200px] xl:w-[282px] sm:h-[49px] text-[16px] xl:text-[20px] font-[600] text-[#4C4886] bg-white rounded-[7px] p-[10px] border-l-[2px] border-[#4C4886] hover:bg-[#4C4886] hover:text-white transition-all duration-200 ease-in-out cursor-pointer">Practice IT Management</li>
                                <li className="w-full sm:w-[200px] xl:w-[282px] sm:h-[49px] text-[16px] xl:text-[20px] font-[600] text-[#4C4886] bg-white rounded-[7px] p-[10px] border-l-[2px] border-[#4C4886] hover:bg-[#4C4886] hover:text-white transition-all duration-200 ease-in-out cursor-pointer">Practice IT Management</li>
                            </ul>
                        </div>
