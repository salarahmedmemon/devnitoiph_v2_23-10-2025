...
const SectionTwo = () => {
    ...
    return (
        <div ref={sectionRef} className="w-full h-[1240px] sm:h-[1400px] md:h-[1300px] lg:h-[798px] bg-[#EEEEEE] overflow-hidden relative pt-[48px]">
            {/* RIGHT CIRCLE */}
            ...
            {/* HEADINGS */}
            <div ref={headingRef} className="w-[190px] sm:w-[303px] h-[100.77px] border-t-[3px] lg:border-t-[5px] border-[#4C4886] absolute left-1/2 -translate-x-1/2">
                <h1 className="text-[28px] sm:text-[38px] lg:text-[44px] font-[500] text-center text-[#333333]">Our Careers</h1>
                <h2 className="text-[28px] sm:text-[38px] lg:text-[44px] font-[600] text-[#4C4886] text-center">Blog</h2>
            </div>
            ...
            <div ref={imageRef} className="lg:hidden w-[90%] h-[310px] md:w-[40%] mx-auto mt-[80px] sm:mt-[120px]">
                <div className="w-full h-full relative ms-[4%]">
                    ...
                    /> */}
                    <img src="/img/careerspage/image04.png" alt="left image" loading="lazy" className="w-full h-full object-contain md:object-cover" />
                </div>
            </div>

            {/* CONTENT */}
            <div ref={contentRef} className="lg:hidden w-[94%] sm:h-[629px] mx-auto flex flex-col items-center sm:mt-[50px]">
                <h1 className="text-[24px] sm:text-[32px] font-[600] text-[#4C4886] sm:border-l-[3px] border-[#4C4886] sm:ps-[6px] mt-[10px]">Our Blog</h1>
                ...
                <div className="w-[242px] sm:w-[400px] mt-[24px] flex flex-col gap-[20px]">
                    <div className="w-full h-[126px] sm:h-[160px] text-center p-[10px]">
                        <h3 className="text-[16px] sm:text-[24px] font-[500] text-[#4C4886]">Alsthetic</h3>
                    ...
                    <div className="w-full h-[126px] sm:h-[160px] text-center p-[10px]">
                        <h3 className="text-[16px] sm:text-[24px]  font-[500] text-[#4C4886]">MenaJobs.ai</h3>
                    ...
                    <div className="w-full h-[126px] sm:h-[160px] text-center p-[10px] mt-[40px] md:mt-0">
                        <h3 className="text-[16px] sm:text-[24px]  font-[500] text-[#4C4886]">APK Hub</h3>
                        <p className="text-[14px] sm:text-[16px]  font-[400] text-[#AAAAAA] pt-[17px]">We deliver custom software and SaaS solutions that are specifically designed to meet the unique needs of your business. Our team ensures excellence in every aspect of our services.</p>
                    </div>
                </div>
            </div>
            ...
            {/* FOR LARGE SCREEN */}
            <div className="hidden lg:flex w-full h-[78%] mt-[200px] justify-center gap-[100px]">
                <div ref={imageRef} className="w-[511px] h-[419px] ms-[5%]">
                    <div className="w-full h-full relative ms-[4%]">
                        {/* <Image
                            ...
                            blurDataURL="data:image/png;base64,"
                        /> */}
                        <img src="/img/careerspage/image04.png" alt="left image" loading="lazy" className="w-full h-full object-contain" />
                    </div>
                </div>
                ...
                <div ref={contentRef} className="w-[700px] h-full me-[5%]">
                    ...
                    <p className="text-[16px] font-[400] mt-[20px] text-[#666]">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's stancenturies,</p>
                    ...
                    <div className="w-full mt-[24px] flex items-center justify-between gap-[14px]">
                        <div className="w-full h-[134px]  sm:h-[200px] ">
                            <h3 className="text-[12px] lg:text-[16px] font-[500] text-[#4C4886]">Alsthetic</h3>
                            <p className="text-[10px] lg:text-[16px] font-[400] text-[#666] pt-[17px]">We deliver custom software and SaaS solutions that are specifically designed to meet the unique needs of your business. </p>
                        </div>

                        <div className="w-full h-[134px] sm:h-[200px] ">
                            <h3 className="text-[12px] lg:text-[16px] font-[500] text-[#4C4886]">MenaJobs.ai</h3>
                            <p className="text-[10px] lg:text-[16px] font-[400] text-[#666] pt-[17px]">We deliver custom software and SaaS solutions that are specifically designed to meet the unique needs of your business. Our team ensures excellence in every aspect of our services.</p>
                        </div>

                        <div className="w-full h-[134px] sm:h-[200px]  mt-[30px] sm:mt-0">
                            <h3 className="text-[12px] lg:text-[16px] font-[500] text-[#4C4886]">APK Hub</h3>
                            <p className="text-[10px] lg:text-[16px] font-[400] text-[#666] pt-[17px]">We deliver custom software and SaaS solutions that are specifically designed to meet the unique needs of your business. Our team ensures excellence in every aspect of our services.</p>
                        </div>
                    </div>
                </div>
