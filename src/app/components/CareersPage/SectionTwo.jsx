...
const SectionTwo = () => {
    ...
    return (
        <div ref={sectionRef} className="w-full h-[1178px] sm:h-[1400px] lg:h-[798px] bg-[#EEEEEE] overflow-hidden relative pt-[48px]">
            {/* RIGHT CIRCLE */}
            ...
            {/* HEADINGS */}
            <div ref={headingRef} className="w-[240px] sm:w-[303px] h-[100.77px] border-t-[3px] lg:border-t-[5px] border-[#4C4886] absolute left-1/2 -translate-x-1/2">
            ...
            <div ref={contentRef} className="lg:hidden w-[94%] h-[629px] mx-auto flex flex-col items-center sm:mt-[50px]">
                {/* <h1 className="w-[190px] sm:w-[202px] h-[40px] border-l-[3px] border-[#4C4886] text-[28px] sm:text-[32px] font-[600] text-[#4C4886] ps-[6px]">Our Blog</h1> */}
                <h1 className="text-[28px] sm:text-[32px] font-[600] text-[#4C4886] border-l-[3px] border-[#4C4886] ps-[6px] mt-[10px]">Our Blog</h1>
                ...
                <div className="w-[242px] sm:w-[400px] mt-[24px] flex flex-col">
                    ...
                    <div className="w-full h-[126px] sm:h-[200px] text-center p-[10px] mt-[30px] sm:mt-0">
