...
const SectionTwo = () => {
    ...
    return (
        <div ref={sectionRef} className="w-full h-[1240px] sm:h-[1400px] lg:h-[798px] bg-[#EEEEEE] overflow-hidden relative pt-[48px]">
            {/* RIGHT CIRCLE */}
            ...
            <div ref={contentRef} className="lg:hidden w-[94%] sm:h-[629px] mx-auto flex flex-col items-center sm:mt-[50px]">
                ...
                <div className="w-[242px] sm:w-[400px] mt-[24px] flex flex-col gap-[20px]">
                    <div className="w-full h-[126px] sm:h-[200px] text-center p-[10px]">
                    ...
                    <div className="w-full h-[126px] sm:h-[200px] text-center p-[10px] mt-[40px]">
                ...
                <div ref={imageRef} className="w-[511px] h-[419px] ms-[5%]">
                    <div className="w-full h-full relative ms-[4%]">
                        {/* <Image
                            ...
                            blurDataURL="data:image/png;base64,"
                        /> */}
                        <img src="/img/careerspage/image04.png" alt="left image" loading="lazy" className="w-full h-full object-cover" />
                    </div>
                </div>
