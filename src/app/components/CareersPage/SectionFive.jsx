                        ...
                        >
                            ...
                            p-[5px] xl:p-[10px]">
                                ...
                                <div className="w-full h-full mt-[10px]">
                                    ...
                                    <h4 className="w-[100%] xl:w-[200px] font-semibold text-[14px] md:text-[18px] lg:text-[16px] text-white mt-[17px]">Few Words "Can Refer To A Phrase"</h4>
                                    <p className="text-[#928D9B] text-[12px] md:text-[16px] lg:text-[14px] mt-[10px] sm:mt-[14px]">Lorem ipsum is simply dummy text</p>
                                    <button className="bg-white text-[#755E9D] w-[67px] h-[20px] sm:w-[70px] sm:h-[22px] rounded-[3px] text-[12px] mt-[10px] sm:mt-[14px]">Read More</button>
                                </div>
                            </div>
                        </div>
                    ))}
