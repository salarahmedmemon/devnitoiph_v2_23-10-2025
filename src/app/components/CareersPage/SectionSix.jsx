const SectionSix = () => {
    ...
    return (
        <div className="w-full h-[1150px] sm:h-[1550px]  md:h-[700px]  bg-[#EEEEEE] relative overflow-hidden pt-[96px]">
            ...
            <div className="mx-auto text-center w-[230px] sm:w-[303px] h-[100px] border-t-[3px] border-[#4C4886] text-[32px] font-[500] z-[90] relative">
                <h1 className="text-[#0A1119]">Our Latest</h1>
                <h2 className="text-[#4C4886]">Article</h2>
            </div>

            <div className="w-[90%] careerspage-sectionsix mx-auto h-[280px] sm:h-[401px] md:h-[280px] lg:h-[401px] flex flex-wrap items-center justify-center gap-[21px] mt-[53px]">
                <div className="w-full md:w-[30%] xl:w-[340px] z-[50] h-full">
                    ...
                    <div className="w-full h-[20%] flex items-center justify-between px-[30px] text-[12px] sm:text-[16px] md:text-[12px] lg:text-[16px] font-[600] text-[#4C4886]">
