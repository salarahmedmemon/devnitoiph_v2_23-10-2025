            ...
            <div className="main-content w-[403px] sm:w-[90%] md:w-[90%] h-[873px] rounded-[26px] absolute top-[-24px] left-1/2 -translate-x-1/2 mt-[58px] z-1000">
                ...
                <div className="desktop-projects w-[94%] hidden lg:flex mx-auto lg:mt-[50px] flex-wrap md:gap-[8px]">
                    ...
                    <div className="project-one w-[20%] h-[260px] lg:h-[350px] p-[2px] gradient-border group">
                        ...
                        <div className="w-full h-full bg-[url('/img/homepage/sectionthree/projectone.png')] bg-cover bg-center relative">
                            ...
                            <div className="w-0 h-0 bg-black absolute bottom-0 right-0 pt-[50px] opacity-0 transition-all duration-500 ease-in-out rounded-tl-full group-hover:w-full group-hover:h-[238px] group-hover:opacity-80">
                                <h3 className="font-500 text-[16px] text-[#FFFFFF] absolute right-[8px] xl:right-[14px]">Printing Media</h3>
                                <h4 className="text-[#1AE4FA] text-[12px] mt-[24px] absolute right-[5px] xl:right-[14px]">Short Detail Here</h4>
                                <p className="text-[12px] text-[#CCCCCC] mt-[60px] ms-[14px] xl:ms-[54px]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi, nisi</p>
                    ...
                    bg-[#000] rounded-tl-full pt-[40px] xl:pt-[50px] ">
                                ...
                                <h3 className="font-[500] text-[16px] text-[#FFFFFF] absolute right-[8px] xl:right-[24px]">Printing Media</h3>
                                <h4 className="text-[#1AE4FA] text-[12px] mt-[24px] absolute right-[5px] xl:right-[14px]">Short Detail Here</h4>
                                <p className="text-[12px] text-[#CCCCCC] ms-[30px] xl:ms-[68px] mt-[54px]">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                                <span className="text-[10px] text-[#CCCCCC] absolute bottom-[16px] left-[18px]">Visit Main Link</span>
                                <span className="text-[10px] text-[#CCCCCC] absolute bottom-[16px] right-[12px] xl:right-[14px]">More Info</span>
                            </div>
                        </div>
                    </div>
                    {/* PROJECT THREE */}
                    ...
                    transition-all duration-500 ease-in-out pt-[80px] xl:pt-[50px] group-hover:opacity-80 rounded-tl-full">
                                <h3 className="font-[500] text-[16px] text-[#FFFFFF] absolute right-[30px] xl:right-[14px]">Printing Media</h3>
                                <h4 className="text-[#1AE4FA] text-[12px] mt-[24px] absolute right-[14px]">Short Detail Here</h4>
                                <p className="text-[12px] text-[#CCCCCC] mt-[55px] ms-[66px]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi, nisi praesentium?</p>
                                <span className="text-[10px] text-[#CCCCCC] absolute bottom-[16px] left-[18px]">Visit Main Link</span>
                                <span className="text-[10px] text-[#CCCCCC] absolute bottom-[16px] right-[18px]">More Info</span>
                            </div>
                        </div>
                    ...
                    <div className="project-four w-[20%] h-[130px] lg:h-[200px] p-[2px] gradient-border group overflow-hidden">
                        <div className="w-full h-full bg-[url('/img/homepage/sectionthree/projectfour.png')] bg-cover bg-center relative">
                            ...
                            {/* OVERLAY */}
                            <div className="overlay w-0 h-0 group-hover:w-[90%] group-hover:h-[90%] bg-[#000] absolute bottom-0 right-0 pt-[50px] xl:pt-[40px] group-hover:opacity-[80%] rounded-tl-full opacity-0
                    transition-all duration-500 ease-in-out">
                                <h3 className="font-[500] text-[16px] text-[#FFFFFF] absolute right-[6px]">Printing Media</h3>
                                <h4 className="text-[#1AE4FA] text-[12px] mt-[20px] absolute right-[8px]">Short Detail Here</h4>
                                <p className="text-[12px] text-[#CCCCCC] mt-[50px] xl:mt-[60px] ms-[20px] xl:ms-[36px]">Lorem ipsum dolor sit amet.</p>
                                <span className="text-[10px] text-[#CCCCCC] absolute bottom-[16px] left-[6px]">Visit Main Link</span>
                                <span className="text-[10px] text-[#CCCCCC] absolute bottom-[16px] right-[10px]">More Info</span>
                            </div>
                        </div>
                    </div>
                    {/* PROJECT FIVE */}
                    ...
                    bg-[#000] rounded-tl-full pt-[80px]">
                                ...
                                <span className="text-[12px] text-[#CCCCCC] absolute bottom-[16px] left-[18px]">Visit Main Link</span>
                                <span className="text-[12px] text-[#CCCCCC] absolute bottom-[16px] right-[18px]">More Info</span>
                            </div>
                        </div>
                    </div>
                    {/* PROJECT SIX */}
                    <div className="project-six w-[38%] lg:h-[200px] p-[2px] gradient-border group overflow-hidden">
                        <div className="w-full h-full bg-[url('/img/homepage/sectionthree/projectsix.png')] bg-cover bg-center relative">
                            ...
                            {/* OVERLAY */}
                            <div className="w-0 h-0 group-hover:w-[70%] xl:group-hover:w-[56%] group-hover:h-full bg-[#000] absolute bottom-0 right-0 opacity-0
                    transition-all duration-500 ease-in-out pt-[46px] group-hover:opacity-80 rounded-tl-full">
                                ...
                                <p className="text-[12px] text-[#CCCCCC] mt-[50px] ms-[68px] xl:mt-[55px]">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                                <span className="text-[10px] text-[#CCCCCC] absolute bottom-[16px] left-[18px]">Visit Main Link</span>
                                <span className="text-[10px] text-[#CCCCCC] absolute bottom-[16px] right-[14px]">More Info</span>
                            </div>
                        </div>
                    </div>
                </div>
