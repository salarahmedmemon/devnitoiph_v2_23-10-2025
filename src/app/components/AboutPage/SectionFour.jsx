  ...
  return (
    <div className="bg-[url('/img/aboutpage/sectionfour/bgImage.png')] bg-cover bg-center w-full h-[442.85px] relative flex flex-col justify-center items-center px-4">
      ...
      <div className="relative text-center mb-10">
        <div className="w-[50vw] sm:w-[28vw] md:w-[16vw] xl:w-[400px] h-[2px] sm:h-[3px] bg-[#71C1E6] absolute left-1/2 -translate-x-1/2 top-[5vw] sm:top-[20%] md:top-[18%]"></div>
        <h1 className="text-2xl sm:text-3xl md:text-4xl text-white pt-8 sm:pt-6">Testimonials</h1>
        <h2 className="text-2xl sm:text-3xl md:text-4xl text-[#71C1E6] font-semibold">Customer Feedback</h2>
      </div>
